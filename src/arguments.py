...
def argparser():
  ...
  # for model
  parser.add_argument('--seq_window_lengths', type=int, nargs='+', default= [12, ],
      help='Space seperated list of motif filter lengths. (ex, --window_lengths 4 8 12)')
  parser.add_argument('--smi_window_lengths', type=int, nargs='+', default= [12, ],
      help='Space seperated list of motif filter lengths. (ex, --window_lengths 4 8 12)')
  ...
  parser.add_argument('--num_hidden', type=int, default=0, help='Number of neurons in hidden layer.')
  parser.add_argument('--num_classes', type=int, default=0, help='Number of classes (families).')
  ...
  parser.add_argument('--dataset_path', type=str, default='../data/kiba/',
      help='Directory for input data.'
  )
  parser.add_argument('--problem_type', type=int, default=1,
      help='Type of the prediction problem (1-4)'
  )
  parser.add_argument('--binary_th', type=float, default=0.0,
